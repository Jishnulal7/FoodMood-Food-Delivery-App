...
import 'package:food_delivery/screens/restaurant/restaurant_listing_screen.dart';
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: FoodCategory.foodCategories.isNotEmpty
                    ? ListView.builder(
                        // itemCount: FoodCategory.foodCategories.length,
                        itemCount: 5,
                        itemBuilder: (context, index) {
                          final FoodCategory currentCategory =
